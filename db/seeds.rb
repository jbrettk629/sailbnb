...
Booking.create(boat_id: 1, user_id: 1, guests: 3, checkin: '01/03/2019', checkout: '05/03/2019')
Booking.create(boat_id: 2, user_id: 1, guests: 4, checkin: '20/12/2018', checkout: '03/01/2019')
...
Review.create(booking_id: 1, overall: 1.5, description: 'first booking')
Review.create(booking_id: 2, overall: 2.5, description: 'second booking')
Review.create(booking_id: 3, overall: 3.5, description: 'third booking')
Review.create(booking_id: 4, overall: 4.5, description: 'fourth booking')

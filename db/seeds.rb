...
# pic6 = File.open('app/assets/images/old-sailboat-sunset.jpeg')
# boat2.photos.attach(io: pic4, filename: 'old-sailboat-sunset.jpeg')
...
# boat5.photos.attach(io: pic10, filename: 'tri-mast-at-dusk.jpg')
...
# pic11 = File.open('app/assets/images/blue-sky-boat-greece.jpg')
# boat5.photos.attach(io: pic11, filename: 'blue-sky-boat-greece')

...
# Boat.create(owner_id: 2, title:'32ft Catamaran', location: 'Princeton, CA', description: 'beautiful boat!!', rate: 250, guests: 6, bedrooms: 3, beds: 3, baths: 1, lat: 37.500052, lng: -142.488629)
# Boat.create(owner_id: 1, title:'28ft Cruiser', location: 'San Francisco, CA', description: 'beautiful boat!!', rate: 150, guests: 3, bedrooms: 1, beds: 1, baths: 1, lat: 37.808302, lng: -122.922182)
# Boat.create(owner_id: 2, title:'43ft Sailboat', location: 'Princeton, CA', description: 'beautiful boat!!', rate: 250, guests: 6, bedrooms: 3, beds: 3, baths: 1, lat: 38.500052, lng: -122.488629)
# Boat.create(owner_id: 1, title:'34ft Houseboat', location: 'San Francisco, CA', description: 'beautiful boat!!', rate: 150, guests: 3, bedrooms: 1, beds: 1, baths: 1, lat: 20.808302, lng: -122.422182)
# Boat.create(owner_id: 2, title:'65ft Yacht', location: 'Princeton, CA', description: 'beautiful boat!!', rate: 250, guests: 6, bedrooms: 3, beds: 3, baths: 1, lat: 30.500052, lng: -122.488629)
# Boat.create(owner_id: 1, title:'50ft Sailboat', location: 'San Francisco, CA', description: 'beautiful boat!!', rate: 150, guests: 3, bedrooms: 1, beds: 1, baths: 1, lat: 40.808302, lng: -122.424182)
